                  ...
                  <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                    ...
                    <div className="flex flex-col space-y-4">
                      <div className="flex space-x-4 justify-between">
                        <a
                          href={`whatsapp://send?text=https://test-website.derkayvargas.com/usados/${detallesAuto.slug}`}
                          className="bg-green-400 text-white px-4 py-2 rounded-full hover:bg-green-500 transition"
                        >
                          <i className="ri-whatsapp-line"></i>
                        </a>
                        <a
                          href={`https://www.facebook.com/sharer/sharer.php?u=https://test-website.derkayvargas.com/usados/${detallesAuto.slug}`}
                          target="_blank"
                        ...
                        <a
                          href={`https://twitter.com/intent/tweet?url=https://test-website.derkayvargas.com/usados/${detallesAuto.slug}`}
                          target="_blank"
                          rel="noopener noreferrer"
                        ...
                        <a
                          href={`mailto:?body=https://test-website.derkayvargas.com/usados/${detallesAuto.slug}`}
                          className="bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600 transition"
                        >
                          <i className="ri-mail-fill"></i>
                        </a>
                        <a
                          href={`sms:?&body=https://test-website.derkayvargas.com/usados/${detallesAuto.slug}`}
