...
export default function NoticiaList({ noticias, categorias }) {
  ...
  const filtrarNoticias = () => {
    ...
    const filtradas = noticias.filter((noticia) => {
      ...
      const coincideBusqueda = palabrasClave.every((palabra) =>
        titulo.includes(palabra)
      );
      const coincideCategorias = filtroCategorias.length
        ? noticia.categories.some((category) =>
            filtroCategorias.includes(category.name)
          )
        : true;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-1 space-y-4 mx-5 lg:mx-0">
          ...
          <div className="mb-4 xl:mx-5 max-lg:hidden rounded-lg bg-gray-100 p-4">
            <h3 className="text-lg font-semibold mb-2 max-w-max border-b-red-600 border-b-2">
          ...
          <div className="bg-gray-100 p-4 xl:mx-5 rounded-lg max-lg:hidden">
            <h3 className="text-2xl font-semibold mb-3 max-w-max border-b-red-500 border-b-2">
              Últimas Noticias
            </h3>
              ...
              {noticias.slice(0, 5).map((noticia) => (
                <li key={noticia.id} className="border-b last:border-0 pb-2">
                  <a
                    ...
                    className="text-gray-600 transition-all ease-in-out text-xl hover:text-red-600"
                  >
                    {noticia.titulo}
                  </a>
        ...
        <div className="lg:col-span-3">
          <div className="flex justify-end mb-4">
            ...
            <button className="mr-2" onClick={() => setModoVista("lista")}>
              <i
                className={`ri-list-unordered ${modoVista === "lista" ? "text-red-600" : "text-gray-700"}`}
              ></i>
            </button>
            <button onClick={() => setModoVista("grilla")}>
              <i
                className={`ri-grid-fill ${modoVista === "grilla" ? "text-red-600" : "text-gray-700"}`}
              ></i>
            </button>
                  ...
                  <TransitionGroup>
                    <CSSTransition timeout={300} classNames="fade">
                      <div className="space-y-4 mx-5">
                        ...
                        <p className="text-gray-600 text-lg border-b-2 border-red-600 pb-2">
                        ...
                        <div className="flex justify-between mt-8">
                          <button
                            ...
                            hidden={
                              noticias.findIndex(
                                (noticia) =>
                                  noticia.id === articuloSeleccionado.id
                              ) === 0
                            }
                          >
                            <i className="ri-arrow-left-s-line"></i>
                    ...
                    <TransitionGroup>
                      ...
                      >
                        <div className="text-center text-gray-500 w-full max-w-full h-screen">
                          ...
                          <p>
                            Intenta realizar una nueva búsqueda o aplicar otros
                            filtros.
                          </p>
                        </div>
                      </CSSTransition>
                      ...
                      {noticiasPaginadas.map((noticia) => (
                        ...
                        >
                          <div className="mx-5 flex flex-col justify-between xl:mx-5 bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 ease-in-out transform hover:scale-105">
                            ...
                            />
                            <div className="p-4">
                              <h2 className="text-base lg:text-lg 2xl:text-xl xl:text-xl font-semibold mb-2">
                                {noticia.titulo}
                              </h2>
                              <div className="mb-4 flex items-center">
                                ...
                                {noticia.categories.map((category) => (
                                  <span
                                    className="inline-block bg-gray-200 text-gray-800 text-xs font-semibold rounded px-2 py-1 mr-2"
                                    key={category.id}
                                  >
                                    {category.name}
                                  </span>
